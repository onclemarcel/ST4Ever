...
*(Current project state: UC1 complete by Claude - under manual code review, build, run and tests)*
*(SPEC-fr.md file will be updated after those manual activities to fed back information to Claude)*
